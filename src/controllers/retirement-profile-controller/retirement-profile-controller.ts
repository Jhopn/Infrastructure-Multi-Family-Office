...
export const createRetirementProfile = async (
  request: FastifyRequest<{
    Body: z.infer<typeof createRetirementProfileSchema>;
  }>,
  reply: FastifyReply,
) => {
  try {
    ...
    if (existingProfile) {
      return reply.code(409).send({
        error: 'A retirement profile already exists for this client.',
      });
    }
    ...
    return reply
      .code(400)
      .send({ error: 'Error creating retirement profile.' });
  }
};
...
export const getRetirementProfile = async (
  ...
  try {
    ...
    return reply
      .code(400)
      .send({ error: 'Error fetching retirement profile.' });
  }
};

export const updateRetirementProfile = async (
  request: FastifyRequest<{
    Body: z.infer<typeof updateRetirementProfileSchema>;
  }>,
  reply: FastifyReply,
) => {
  try {
    ...
    return reply
      .code(400)
      .send({ error: 'Error updating retirement profile.' });
  }
};

export const deleteRetirementProfile = async (
  request: FastifyRequest,
  reply: FastifyReply,
) => {
  try {
    ...
    return reply
      .code(400)
      .send({ error: 'Error deleting retirement profile.' });
  }
};
